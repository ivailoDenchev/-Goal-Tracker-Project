...
import { FiCalendar, FiChevronLeft, FiChevronRight, FiCheckCircle, FiPlus, FiSearch, FiX, FiUsers } from 'react-icons/fi';
import { format, addDays } from 'date-fns';
import CreateGoalCalendar from './CreateGoalCalendar';
import { useGoals } from '../contexts/GoalContext';

const GoalsDashboard: React.FC = () => {
  const today = new Date();
  const { goals, getTasksForDate, addTarget } = useGoals();
